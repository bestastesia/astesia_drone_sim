...
class ControllerNode : public rclcpp::Node {
 ...
 private:
  void declareParams() {
    ...
    declare_parameter<std::vector<double>>("Kp_pos", {3.0, 3.0, 5.0});
    declare_parameter<std::vector<double>>("Kd_pos", {1.5, 1.5, 2.5});
    declare_parameter<std::vector<double>>("Ki_pos", {0.0, 0.0, 0.0});
    declare_parameter<double>("Ki_max", 1.0);
    declare_parameter<double>("a_xy_max", 5.0);
    ...
    declare_parameter<std::vector<double>>("Kp_att", {10.0, 10.0, 5.0});
    declare_parameter<std::vector<double>>("Kd_rate", {3.0, 3.0, 2.0});
